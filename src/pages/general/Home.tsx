      ...
      <section className="bg-[#E4EFE7] text-center min-h-[100vh] flex items-center justify-center px-4 py-8 md:p-8 lg:px-[5%]">
        <div>
          ...
          <p className="text-gray-600">
            Leverage Effiflow to transform Product Requirements into Actionable
      ...
      <section className="bg-[var(--secondary-color)] p-[5%]">
        <div>
          ...
          <p className="text-gray-800">
            Everything you need to know about Effiflow
          </p>
          ...
          <div className="mt-8 md:grid md:grid-cols-2 gap-6">
            <div className="border border-gray-800 px-4 py-6 rounded-lg mb-6">
              ...
              <p className="text-gray-600">
                EffiFlow is an upcoming comprehensive product management
                software designed to streamline and enhance every aspect of your
                product development journey. EffiFlow is your all-in-one
            ...
            <div className="border border-gray-800 px-4 py-6 rounded-lg mb-6">
              ...
              <p className="text-gray-600">
                EffiFlow is designed with you in mind. Our user-centric approach
            ...
            <div className="border border-gray-800 px-4 py-6 rounded-lg mb-6">
              ...
              <p className="text-gray-600">
                EffiFlow is more than just software, we're your committed
            ...
            <div className="border border-gray-800 px-4 py-6 rounded-lg mb-6">
              ...
              <p className="text-gray-600">
                EffiFlow offers a holistic approach to product management. We
